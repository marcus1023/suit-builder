...
function collect(){
  ...
  checkCollect();
// Front
  let frla = " Front Right Lower Leg: " + document.getElementById("frla-title").innerHTML + " / "
  let flla = " Front Left Lower Leg: " + document.getElementById("flla-title").innerHTML + " / "
  let fre = " Front Right Elbow: " + document.getElementById("fre-title").innerHTML + " / "
  let fle = " Front Left Elbow: " + document.getElementById("fle-title").innerHTML + " / "
  let frua = " Front Right Upper Arm: " + document.getElementById("frua-title").innerHTML + " / "
  let flua = " Front Left Upper Arm: " + document.getElementById("flua-title").innerHTML + " / "
  let faly = " Arm Lyrica: " + document.getElementById("faly-title").innerHTML + " / "
  let frs = " Front Right Sholder: " + document.getElementById("frs-title").innerHTML + " / "
  let fls = " Front Left Sholder: " + document.getElementById("fls-title").innerHTML + " / "
  let frc = " Front Right Chest: " + document.getElementById("frc-title").innerHTML + " / "
  let flc = " Front Left Chest: " + document.getElementById("flc-title").innerHTML + " / "
  let fc = " Collar: " + document.getElementById("fc-title").innerHTML + " / "
  let frcrotch = " Front Right Crotch: " + document.getElementById("frcrotch-title").innerHTML + " / "
  let flcrotch = " Front Left Crotch: " + document.getElementById("flcrotch-title").innerHTML + " / "
  ...
  let frly = " Front Right Lyrica: " + document.getElementById("frly-title").innerHTML + " / "
  let flly = " Front Left Lyrica: " + document.getElementById("flly-title").innerHTML + " / "
  let frml = " Front Right Middle Leg: " + document.getElementById("frml-title").innerHTML + " / "
  let flml = " Front Left Middle Leg: " + document.getElementById("flml-title").innerHTML + " / "
  let frll = " Front Right Lower Leg: " + document.getElementById("frll-title").innerHTML + " / "
  let flll = " Front Left Lower Leg: " + document.getElementById("flll-title").innerHTML + " / "
  let stitch = " Stitching: " + document.getElementById("line-title").innerHTML + " / "
  let collar = " Collar: " + document.getElementById("fc-title").innerHTML + " / "


  let allFrontValues = stitch+frla+flla+fre+fle+frua+flua+faly+frs+fls+frc+flc+fc+frcrotch+flcrotch+frul+flul+frly+flly+frll+flll
// Back
  let blla = " Back Left Lower Arm: " + document.getElementById("blla-title").innerHTML + " / "
  let brla = " Back Right Lower Arm: " + document.getElementById("brla-title").innerHTML + " / "
  let bleb = " Back Left Elbow: " + document.getElementById("bleb-title").innerHTML + " / "
  let breb = " Back Right Elbow: " + document.getElementById("breb-title").innerHTML + " / "
  let blua = " Back Left Upper Arm: " + document.getElementById("blua-title").innerHTML + " / "
  let brua = " Back Right Upper Arm: " + document.getElementById("brua-title").innerHTML + " / "
  let blsh = " Back Left Sholder: " + document.getElementById("blsh-title").innerHTML + " / "
  let brsh = " Back Right Sholder: " + document.getElementById("brsh-title").innerHTML + " / "
  let back = " Back: " + document.getElementById("back-title").innerHTML + " / "
  let blcr = " Back Left Crotch: " + document.getElementById("blcr-title").innerHTML + " / "
  let brcr = " Back Right Crotch: " + document.getElementById("brcr-title").innerHTML + " / "
  ...
  let allBackValues = blla+brla+bleb+breb+blua+brua+blsh+brsh+back+blcr+brcr+blll+brll
  //measurements
  ...
  let FULL_ARM_BENT_LENGTH = " FULL_ARM_BENT_LENGTH: " + document.getElementById("FULL_ARM_BENT_LENGTH").value + " / "
  ...
  let tm = " TORSO MATERIAL: " + document.getElementById("select-lafab-title").innerHTML + " / "

  let allMeasurements = NECK_CIRCUMFERENCE+SHOULDER_TO_SHOULDER+SHOULDER_TO_ELBOW_LENGTH+CHEST_CIRCUMFERENCE+TORSO_LENGTH+BICEP_CIRCUMFERENCE+WAIST_CIRCUMFERENCE+HIPS_CIRCUMFERENCE+THIGH_CIRCUMFERENCE+CROTCH_TO_KNEE_LENGTH+ELBOW_TO_WRIST_LENGTH+FULL_ARM_BENT_LENGTH+IN_SEAM_LENGTH+CALF_CIRCUMFERENCE+LOWER_LEG_LENGTH+ANKLE_CIRCUMFERENCE+FOOT_LENGTH_SIZE+ELBOW_TO_WRIST_LENGTH+FOREARM_CIRCUMFERENCE+FOOT_TO_SHOULDER_LENGTH
...
function colorPickerSelectBack(color){
  ...
  if(color === 'back-backCam1'){
    document.getElementById('back-label').style.background = "url('http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png')"
    document.getElementById("back-title").innerHTML = "Green Camo";
    document.getElementById('back').style.fill = 'url(#backCam1)'
    document.getElementById('color-picker-dropdown-back').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'blla-aqua'){
  ...
  if(color === 'blll-gCamo'){
    document.getElementById('blll-label').style.background = "url('http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png')"
    document.getElementById("blll-title").innerHTML = "Green Camo";
    document.getElementById('blll').style.fill = 'url(#blllgCamo)'
    document.getElementById('color-picker-dropdown-blll').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brll-aqua'){
...
function colorPickerDropdownFront(drop){
  ...
  if(drop === 'frua'){
    document.getElementById('color-picker-dropdown-frua').style.display = 'flex'
  }
  if(drop === 'flua'){
    document.getElementById('color-picker-dropdown-flua').style.display = 'flex'
  }
  if(drop === 'frcrotch'){
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'flex'
  }
  if(drop === 'flcrotch'){
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'flex'
  }
  if(drop === 'faly'){
    document.getElementById('color-picker-dropdown-faly').style.display = 'flex'
  }
  if(drop === 'frml'){
...
function colorPickerSelectFront(color){
  ...
  // front left crotch
  // front right sholder
  if(color === 'flcrotch-aqua'){
    console.log('here')
    document.getElementById('flcrotch-label').style.background = '#129793'
    document.getElementById("flcrotch-title").innerHTML = "Aqua";
    document.getElementById('flcrotch').style.fill = '#129793'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-neon-green'){
    document.getElementById('flcrotch-label').style.background = '#29f04f'
    document.getElementById("flcrotch-title").innerHTML = "Neon Green";
    document.getElementById('flcrotch').style.fill = '#29f04f'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-hot-pink'){
    document.getElementById('flcrotch-label').style.background = '#e929f0'
    document.getElementById("flcrotch-title").innerHTML = "Hot Pink";
    document.getElementById('flcrotch').style.fill = '#e929f0'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-yellow'){
    document.getElementById('flcrotch-label').style.background = 'yellow'
    document.getElementById("flcrotch-title").innerHTML = "Yellow";
    document.getElementById('flcrotch').style.fill = 'yellow'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-maroon'){
    document.getElementById('flcrotch-label').style.background = '#cb0039'
    document.getElementById("flcrotch-title").innerHTML = "Maroon";
    document.getElementById('flcrotch').style.fill = '#cb0039'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-grey'){
    document.getElementById('flcrotch-label').style.background = '#969696'
    document.getElementById("flcrotch-title").innerHTML = "Grey";
    document.getElementById('flcrotch').style.fill = '#969696'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-navy'){
    document.getElementById('flcrotch-label').style.background = '#152c91'
    document.getElementById("flcrotch-title").innerHTML = "Navy";
    document.getElementById('flcrotch').style.fill = '#152c91'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-purple'){
    document.getElementById('flcrotch-label').style.background = 'purple'
    document.getElementById("flcrotch-title").innerHTML = "Purple";
    document.getElementById('flcrotch').style.fill = 'purple'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-darkGreen'){
    document.getElementById('flcrotch-label').style.background = 'Green'
    document.getElementById("flcrotch-title").innerHTML = "Green";
    document.getElementById('flcrotch').style.fill = 'Green'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-darkGrey'){
    document.getElementById('flcrotch-label').style.background = '#494949'
    document.getElementById("flcrotch-title").innerHTML = "Dark Grey";
    document.getElementById('flcrotch').style.fill = '#494949'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-blue'){
    document.getElementById('flcrotch-label').style.background = 'blue'
    document.getElementById("flcrotch-title").innerHTML = "Blue";
    document.getElementById('flcrotch').style.fill = 'blue'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-lime'){
    document.getElementById('flcrotch-label').style.background = '#09b600'
    document.getElementById("flcrotch-title").innerHTML = "Lime";
    document.getElementById('flcrotch').style.fill = '#09b600'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-white'){
    document.getElementById('flcrotch-label').style.background = 'White'
    document.getElementById("flcrotch-title").innerHTML = "White";
    document.getElementById('flcrotch').style.fill = 'White'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-black'){
    document.getElementById('flcrotch-label').style.background = 'Black'
    document.getElementById("flcrotch-title").innerHTML = "Black";
    document.getElementById('flcrotch').style.fill = 'Black'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flcrotch-teal'){
    document.getElementById('flcrotch-label').style.background = '#00b692'
    document.getElementById("flcrotch-title").innerHTML = "Teal";
    document.getElementById('flcrotch').style.fill = '#00b692'
    document.getElementById('color-picker-dropdown-flcrotch').style.display = 'none'
    dropdownCtrl = true
  }
//front lyrica
...
if(color === 'faly-aqua'){
  console.log('here')
  document.getElementById('faly-label').style.background = '#129793'
  document.getElementById("faly-title").innerHTML = "Aqua";
  document.getElementById('faly').style.fill = '#129793'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-neon-green'){
  document.getElementById('faly-label').style.background = '#29f04f'
  document.getElementById("faly-title").innerHTML = "Neon Green";
  document.getElementById('faly').style.fill = '#29f04f'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-hot-pink'){
  document.getElementById('faly-label').style.background = '#e929f0'
  document.getElementById("faly-title").innerHTML = "Hot Pink";
  document.getElementById('faly').style.fill = '#e929f0'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-yellow'){
  document.getElementById('faly-label').style.background = 'yellow'
  document.getElementById("faly-title").innerHTML = "Yellow";
  document.getElementById('faly').style.fill = 'yellow'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-maroon'){
  document.getElementById('faly-label').style.background = '#cb0039'
  document.getElementById("faly-title").innerHTML = "Maroon";
  document.getElementById('faly').style.fill = '#cb0039'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-grey'){
  document.getElementById('faly-label').style.background = '#969696'
  document.getElementById("faly-title").innerHTML = "Grey";
  document.getElementById('faly').style.fill = '#969696'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-navy'){
  document.getElementById('faly-label').style.background = '#152c91'
  document.getElementById("faly-title").innerHTML = "Navy";
  document.getElementById('faly').style.fill = '#152c91'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-purple'){
  document.getElementById('faly-label').style.background = 'purple'
  document.getElementById("faly-title").innerHTML = "Purple";
  document.getElementById('faly').style.fill = 'purple'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-darkGreen'){
  document.getElementById('faly-label').style.background = 'Green'
  document.getElementById("faly-title").innerHTML = "Green";
  document.getElementById('faly').style.fill = 'Green'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-darkGrey'){
  document.getElementById('faly-label').style.background = '#494949'
  document.getElementById("faly-title").innerHTML = "Dark Grey";
  document.getElementById('faly').style.fill = '#494949'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-blue'){
  document.getElementById('faly-label').style.background = 'blue'
  document.getElementById("faly-title").innerHTML = "Blue";
  document.getElementById('faly').style.fill = 'blue'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-lime'){
  document.getElementById('faly-label').style.background = '#09b600'
  document.getElementById("faly-title").innerHTML = "Lime";
  document.getElementById('faly').style.fill = '#09b600'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-white'){
  document.getElementById('faly-label').style.background = 'White'
  document.getElementById("faly-title").innerHTML = "White";
  document.getElementById('faly').style.fill = 'White'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-black'){
  document.getElementById('faly-label').style.background = 'Black'
  document.getElementById("faly-title").innerHTML = "Black";
  document.getElementById('faly').style.fill = 'Black'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'faly-teal'){
  document.getElementById('faly-label').style.background = '#00b692'
  document.getElementById("faly-title").innerHTML = "Teal";
  document.getElementById('faly').style.fill = '#00b692'
  document.getElementById('color-picker-dropdown-faly').style.display = 'none'
  dropdownCtrl = true
}
...
if(color === 'flua-aqua'){
  console.log('here')
  document.getElementById('flua-label').style.background = '#129793'
  document.getElementById("flua-title").innerHTML = "Aqua";
  document.getElementById('flua').style.fill = '#129793'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-neon-green'){
  document.getElementById('flua-label').style.background = '#29f04f'
  document.getElementById("flua-title").innerHTML = "Neon Green";
  document.getElementById('flua').style.fill = '#29f04f'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-hot-pink'){
  document.getElementById('flua-label').style.background = '#e929f0'
  document.getElementById("flua-title").innerHTML = "Hot Pink";
  document.getElementById('flua').style.fill = '#e929f0'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-yellow'){
  document.getElementById('flua-label').style.background = 'yellow'
  document.getElementById("flua-title").innerHTML = "Yellow";
  document.getElementById('flua').style.fill = 'yellow'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-maroon'){
  document.getElementById('flua-label').style.background = '#cb0039'
  document.getElementById("flua-title").innerHTML = "Maroon";
  document.getElementById('flua').style.fill = '#cb0039'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-grey'){
  document.getElementById('flua-label').style.background = '#969696'
  document.getElementById("flua-title").innerHTML = "Grey";
  document.getElementById('flua').style.fill = '#969696'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-navy'){
  document.getElementById('flua-label').style.background = '#152c91'
  document.getElementById("flua-title").innerHTML = "Navy";
  document.getElementById('flua').style.fill = '#152c91'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-purple'){
  document.getElementById('flua-label').style.background = 'purple'
  document.getElementById("flua-title").innerHTML = "Purple";
  document.getElementById('flua').style.fill = 'purple'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-darkGreen'){
  document.getElementById('flua-label').style.background = 'Green'
  document.getElementById("flua-title").innerHTML = "Green";
  document.getElementById('flua').style.fill = 'Green'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-darkGrey'){
  document.getElementById('flua-label').style.background = '#494949'
  document.getElementById("flua-title").innerHTML = "Dark Grey";
  document.getElementById('flua').style.fill = '#494949'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-blue'){
  document.getElementById('flua-label').style.background = 'blue'
  document.getElementById("flua-title").innerHTML = "Blue";
  document.getElementById('flua').style.fill = 'blue'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-lime'){
  document.getElementById('flua-label').style.background = '#09b600'
  document.getElementById("flua-title").innerHTML = "Lime";
  document.getElementById('flua').style.fill = '#09b600'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-white'){
  document.getElementById('flua-label').style.background = 'White'
  document.getElementById("flua-title").innerHTML = "White";
  document.getElementById('flua').style.fill = 'White'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-black'){
  document.getElementById('flua-label').style.background = 'Black'
  document.getElementById("flua-title").innerHTML = "Black";
  document.getElementById('flua').style.fill = 'Black'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
if(color === 'flua-teal'){
  document.getElementById('flua-label').style.background = '#00b692'
  document.getElementById("flua-title").innerHTML = "Teal";
  document.getElementById('flua').style.fill = '#00b692'
  document.getElementById('color-picker-dropdown-flua').style.display = 'none'
  dropdownCtrl = true
}
  ...
  if(color === 'frua-aqua'){
    console.log('here')
    document.getElementById('frua-label').style.background = '#129793'
    document.getElementById("frua-title").innerHTML = "Aqua";
    document.getElementById('frua').style.fill = '#129793'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-neon-green'){
    document.getElementById('frua-label').style.background = '#29f04f'
    document.getElementById("frua-title").innerHTML = "Neon Green";
    document.getElementById('frua').style.fill = '#29f04f'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-hot-pink'){
    document.getElementById('frua-label').style.background = '#e929f0'
    document.getElementById("frua-title").innerHTML = "Hot Pink";
    document.getElementById('frua').style.fill = '#e929f0'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-yellow'){
    document.getElementById('frua-label').style.background = 'yellow'
    document.getElementById("frua-title").innerHTML = "Yellow";
    document.getElementById('frua').style.fill = 'yellow'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-maroon'){
    document.getElementById('frua-label').style.background = '#cb0039'
    document.getElementById("frua-title").innerHTML = "Maroon";
    document.getElementById('frua').style.fill = '#cb0039'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-grey'){
    document.getElementById('frua-label').style.background = '#969696'
    document.getElementById("frua-title").innerHTML = "Grey";
    document.getElementById('frua').style.fill = '#969696'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-navy'){
    document.getElementById('frua-label').style.background = '#152c91'
    document.getElementById("frua-title").innerHTML = "Navy";
    document.getElementById('frua').style.fill = '#152c91'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-purple'){
    document.getElementById('frua-label').style.background = 'purple'
    document.getElementById("frua-title").innerHTML = "Purple";
    document.getElementById('frua').style.fill = 'purple'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-darkGreen'){
    document.getElementById('frua-label').style.background = 'Green'
    document.getElementById("frua-title").innerHTML = "Green";
    document.getElementById('frua').style.fill = 'Green'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-darkGrey'){
    document.getElementById('frua-label').style.background = '#494949'
    document.getElementById("frua-title").innerHTML = "Dark Grey";
    document.getElementById('frua').style.fill = '#494949'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-blue'){
    document.getElementById('frua-label').style.background = 'blue'
    document.getElementById("frua-title").innerHTML = "Blue";
    document.getElementById('frua').style.fill = 'blue'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-lime'){
    document.getElementById('frua-label').style.background = '#09b600'
    document.getElementById("frua-title").innerHTML = "Lime";
    document.getElementById('frua').style.fill = '#09b600'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-white'){
    document.getElementById('frua-label').style.background = 'White'
    document.getElementById("frua-title").innerHTML = "White";
    document.getElementById('frua').style.fill = 'White'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-black'){
    document.getElementById('frua-label').style.background = 'Black'
    document.getElementById("frua-title").innerHTML = "Black";
    document.getElementById('frua').style.fill = 'Black'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frua-teal'){
    document.getElementById('frua-label').style.background = '#00b692'
    document.getElementById("frua-title").innerHTML = "Teal";
    document.getElementById('frua').style.fill = '#00b692'
    document.getElementById('color-picker-dropdown-frua').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  //front right crotch
  // front right sholder
  if(color === 'frcrotch-aqua'){
    console.log('here')
    document.getElementById('frcrotch-label').style.background = '#129793'
    document.getElementById("frcrotch-title").innerHTML = "Aqua";
    document.getElementById('frcrotch').style.fill = '#129793'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-neon-green'){
    document.getElementById('frcrotch-label').style.background = '#29f04f'
    document.getElementById("frcrotch-title").innerHTML = "Neon Green";
    document.getElementById('frcrotch').style.fill = '#29f04f'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-hot-pink'){
    document.getElementById('frcrotch-label').style.background = '#e929f0'
    document.getElementById("frcrotch-title").innerHTML = "Hot Pink";
    document.getElementById('frcrotch').style.fill = '#e929f0'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-yellow'){
    document.getElementById('frcrotch-label').style.background = 'yellow'
    document.getElementById("frcrotch-title").innerHTML = "Yellow";
    document.getElementById('frcrotch').style.fill = 'yellow'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-maroon'){
    document.getElementById('frcrotch-label').style.background = '#cb0039'
    document.getElementById("frcrotch-title").innerHTML = "Maroon";
    document.getElementById('frcrotch').style.fill = '#cb0039'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-grey'){
    document.getElementById('frcrotch-label').style.background = '#969696'
    document.getElementById("frcrotch-title").innerHTML = "Grey";
    document.getElementById('frcrotch').style.fill = '#969696'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-navy'){
    document.getElementById('frcrotch-label').style.background = '#152c91'
    document.getElementById("frcrotch-title").innerHTML = "Navy";
    document.getElementById('frcrotch').style.fill = '#152c91'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-purple'){
    document.getElementById('frcrotch-label').style.background = 'purple'
    document.getElementById("frcrotch-title").innerHTML = "Purple";
    document.getElementById('frcrotch').style.fill = 'purple'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-darkGreen'){
    document.getElementById('frcrotch-label').style.background = 'Green'
    document.getElementById("frcrotch-title").innerHTML = "Green";
    document.getElementById('frcrotch').style.fill = 'Green'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-darkGrey'){
    document.getElementById('frcrotch-label').style.background = '#494949'
    document.getElementById("frcrotch-title").innerHTML = "Dark Grey";
    document.getElementById('frcrotch').style.fill = '#494949'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-blue'){
    document.getElementById('frcrotch-label').style.background = 'blue'
    document.getElementById("frcrotch-title").innerHTML = "Blue";
    document.getElementById('frcrotch').style.fill = 'blue'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-lime'){
    document.getElementById('frcrotch-label').style.background = '#09b600'
    document.getElementById("frcrotch-title").innerHTML = "Lime";
    document.getElementById('frcrotch').style.fill = '#09b600'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-white'){
    document.getElementById('frcrotch-label').style.background = 'White'
    document.getElementById("frcrotch-title").innerHTML = "White";
    document.getElementById('frcrotch').style.fill = 'White'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-black'){
    document.getElementById('frcrotch-label').style.background = 'Black'
    document.getElementById("frcrotch-title").innerHTML = "Black";
    document.getElementById('frcrotch').style.fill = 'Black'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frcrotch-teal'){
    document.getElementById('frcrotch-label').style.background = '#00b692'
    document.getElementById("frcrotch-title").innerHTML = "Teal";
    document.getElementById('frcrotch').style.fill = '#00b692'
    document.getElementById('color-picker-dropdown-frcrotch').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'gcamo-teal'){
    document.getElementById('fc-label').style.background = "url('http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png')"
    document.getElementById("fc-title").innerHTML = "Green Camo";
    document.getElementById('fc').style.fill = 'url(#bcolCam)'
    document.getElementById('bcol').style.fill = 'url(#bcolCam1)'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
