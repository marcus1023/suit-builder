...
function colorPickerSelectFront(color){
  ...
  if(color === 'fins-red'){
    console.log('here')
    document.getElementById('fins-label').style.background = 'red'
    document.getElementById("fins-title").innerHTML = "Red";
    document.getElementById('fins').style.fill = 'red'
  ...
  if(color === 'fins-black'){
    document.getElementById('fins-label').style.background = 'finsack'
    document.getElementById("fins-title").innerHTML = "finsack";
    document.getElementById('fins').style.fill = 'finsack'
    document.getElementById('bins').style.fill = 'finsack'
    document.getElementById('color-picker-dropdown-fins').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fins-teal'){
