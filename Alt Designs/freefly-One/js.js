...
// Front
  ...
  let frla = " Front Right Lower Arm: " + document.getElementById("frla-title").innerHTML + " / "
  let frs = " Front Right Sholder: " + document.getElementById("frs-title").innerHTML + " / "
  let frside = " Front Right Side: " + document.getElementById("frside-title").innerHTML + " / "
  ...
  let flside = " Front Left Side: " + document.getElementById("flside-title").innerHTML + " / "
  let fls = " Front Left Sholder: " + document.getElementById("fls-title").innerHTML + " / "
  let flla = " Front Left Lower Arm: " + document.getElementById("flla-title").innerHTML + " / "
  ...
  let line = " Lineing: " + document.getElementById("line-title").innerHTML + " / "
  let pipe = " Front Pipeing: " + document.getElementById("pipe-title").innerHTML + " / "




  let allFrontValues = frla+frs+frside+frc+flc+flside+fls+flla+fre+fle+frly+flly+frul+flul+frll+flll+line+pipe
// Back
  let bcollar = " Collar: " + document.getElementById("fc-title").innerHTML + " / "
  let bback = " Back: " + document.getElementById("back-title").innerHTML + " / "
  let blla = " Back Left Arm: " + document.getElementById("blla-title").innerHTML + " / "
  let brla = " Back Right Arm: " + document.getElementById("brla-title").innerHTML + " / "
  let ble = " Back Left Elbow: " + document.getElementById("ble-title").innerHTML + " / "
  let bre = " Back Right Elbow: " + document.getElementById("bre-title").innerHTML + " / "
  ...
  let blsh = " Back Right Upper Arm: " + document.getElementById("blsh-title").innerHTML + " / "
  ...
  let allBackValues = bcollar+bback+blla+brla+ble+bre+blua+brua+brsh+blsh+blly+brly+blul+brul+blll+brll
//Measurements
  ...
  let allMeasurements = NECK_CIRCUMFERENCE+SHOULDER_TO_SHOULDER+SHOULDER_TO_ELBOW_LENGTH+CHEST_CIRCUMFERENCE+TORSO_LENGTH+BICEP_CIRCUMFERENCE+WAIST_CIRCUMFERENCE+HIPS_CIRCUMFERENCE+THIGH_CIRCUMFERENCE+CROTCH_TO_KNEE_LENGTH
...
function colorPickerSelectFront(color){
  ...
  if(color === 'flly-fllygCamo'){
    document.getElementById('flly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("flly-title").innerHTML = "Green Camo";
    document.getElementById('flly').style.fill = 'url("#defagCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flly-fllypCamo'){
    document.getElementById('flly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("flly-title").innerHTML = "Pink Camo";
    document.getElementById('flly').style.fill = 'url("#defapCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flly-fllybCamo'){
    document.getElementById('flly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("flly-title").innerHTML = "Blue Camo";
    document.getElementById('flly').style.fill = 'url("#defabCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flly-fllywCamo'){
    document.getElementById('flly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("flly-title").innerHTML = "White Camo";
    document.getElementById('flly').style.fill = 'url("#defawCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flly').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'frly-frlygCamo'){
    document.getElementById('frly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("frly-title").innerHTML = "Green Camo";
    document.getElementById('frly').style.fill = 'url("#defagCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frly-frlypCamo'){
    document.getElementById('frly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("frly-title").innerHTML = "Pink Camo";
    document.getElementById('frly').style.fill = 'url("#defapCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frly-frlybCamo'){
    document.getElementById('frly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("frly-title").innerHTML = "Blue Camo";
    document.getElementById('frly').style.fill = 'url("#defabCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frly').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frly-frlywCamo'){
    document.getElementById('frly-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("frly-title").innerHTML = "White Camo";
    document.getElementById('frly').style.fill = 'url("#defawCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frly').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'fle-red'){
    document.getElementById('fle-label').style.background = 'red'
    document.getElementById("fle-title").innerHTML = "Red";
    document.getElementById('fle').style.fill = 'red'
    document.getElementById('color-picker-dropdown-fle').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fle-grey'){
  ...
  if(color === 'fre-red'){
    document.getElementById('fre-label').style.background = 'red'
    document.getElementById("fre-title").innerHTML = "Red";
    document.getElementById('fre').style.fill = 'red'
    document.getElementById('color-picker-dropdown-fre').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fre-grey'){
  ...
  if(color === 'flla-red'){
    document.getElementById('flla-label').style.background = 'red'
    document.getElementById("flla-title").innerHTML = "Red";
    document.getElementById('flla').style.fill = 'red'
    document.getElementById('color-picker-dropdown-flla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flla-grey'){
  ...
  if(color === 'flla-fllagCamo'){
    document.getElementById('flla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("flla-title").innerHTML = "Green Camo";
    document.getElementById('flla').style.fill = 'url("#defagCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flla-fllapCamo'){
    document.getElementById('flla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("flla-title").innerHTML = "Pink Camo";
    document.getElementById('flla').style.fill = 'url("#defapCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flla-fllabCamo'){
    document.getElementById('flla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("flla-title").innerHTML = "Blue Camo";
    document.getElementById('flla').style.fill = 'url("#defabCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flla-fllawCamo'){
    document.getElementById('flla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("flla-title").innerHTML = "White Camo";
    document.getElementById('flla').style.fill = 'url("#defawCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flla').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  //front left sholder
  if(color === 'fls-flsgCamo'){
    document.getElementById('fls-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("fls-title").innerHTML = "Green Camo";
    document.getElementById('fls').style.fill = 'url("#defagCamo")'
    document.getElementById('color-picker-dropdown-fls').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fls-flspCamo'){
    document.getElementById('fls-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("fls-title").innerHTML = "Pink Camo";
    document.getElementById('fls').style.fill = 'url("#defapCamo")'
    document.getElementById('color-picker-dropdown-fls').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fls-flsbCamo'){
    document.getElementById('fls-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("fls-title").innerHTML = "Blue Camo";
    document.getElementById('fls').style.fill = 'url("#defabCamo")'
    document.getElementById('color-picker-dropdown-fls').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fls-flswCamo'){
    document.getElementById('fls-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("fls-title").innerHTML = "White Camo";
    document.getElementById('fls').style.fill = 'url("#defawCamo")'
    document.getElementById('color-picker-dropdown-fls').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fls-aqua'){
  ...
  if(color === 'fls-red'){
    document.getElementById('fls-label').style.background = 'red'
    document.getElementById("fls-title").innerHTML = "Red";
    document.getElementById('fls').style.fill = 'red'
    document.getElementById('color-picker-dropdown-fls').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fls-grey'){
  ...
  if(color === 'flside-red'){
    document.getElementById('flside-label').style.background = 'red'
    document.getElementById("flside-title").innerHTML = "Red";
    document.getElementById('flside').style.fill = 'red'
    document.getElementById('color-picker-dropdown-flside').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  //Front Left chest
  if(color === 'flc-flcgCamo'){
    document.getElementById('flc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("flc-title").innerHTML = "Green Camo";
    document.getElementById('flc').style.fill = 'url("#defagCamo")'
    document.getElementById('color-picker-dropdown-flc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flc-flcpCamo'){
    document.getElementById('flc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("flc-title").innerHTML = "Pink Camo";
    document.getElementById('flc').style.fill = 'url("#defapCamo")'
    document.getElementById('caos-leg-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flc-flcbCamo'){
    document.getElementById('flc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("flc-title").innerHTML = "Blue Camo";
    document.getElementById('flc').style.fill = 'url("#defabCamo")'
    document.getElementById('color-picker-dropdown-flc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flc-flcwCamo'){
    document.getElementById('flc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("flc-title").innerHTML = "White Camo";
    document.getElementById('flc').style.fill = 'url("#defawCamo")'
    document.getElementById('color-picker-dropdown-flc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'flc-aqua'){
  ...
  if(color === 'flc-red'){
    document.getElementById('flc-label').style.background = 'red'
    document.getElementById("flc-title").innerHTML = "Red";
    document.getElementById('flc').style.fill = 'red'
    document.getElementById('caos-leg-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-flc').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  //Front right chest
  if(color === 'frc-frcgCamo'){
    document.getElementById('frc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("frc-title").innerHTML = "Green Camo";
    document.getElementById('frc').style.fill = 'url("#defagCamo")'
    document.getElementById('color-picker-dropdown-frc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frc-frcpCamo'){
    document.getElementById('frc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("frc-title").innerHTML = "Pink Camo";
    document.getElementById('frc').style.fill = 'url("#defapCamo")'
    document.getElementById('color-picker-dropdown-frc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frc-frcbCamo'){
    document.getElementById('frc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("frc-title").innerHTML = "Blue Camo";
    document.getElementById('frc').style.fill = 'url("#defabCamo")'
    document.getElementById('color-picker-dropdown-frc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frc-frcwCamo'){
    document.getElementById('frc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("frc-title").innerHTML = "White Camo";
    document.getElementById('frc').style.fill = 'url("#defawCamo")'
    document.getElementById('color-picker-dropdown-frc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frc-aqua'){
  ...
  if(color === 'frc-red'){
    document.getElementById('frc-label').style.background = 'red'
    document.getElementById("frc-title").innerHTML = "Red";
    document.getElementById('frc').style.fill = 'red'
    document.getElementById('chute-out-text').style.color = 'white'
    document.getElementById('color-picker-dropdown-frc').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  //front right side
  if(color === 'frs-frsgCamo'){
    document.getElementById('frs-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("frs-title").innerHTML = "Green Camo";
    document.getElementById('frs').style.fill = 'url("#defagCamo")'
    document.getElementById('color-picker-dropdown-frs').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frs-frspCamo'){
    document.getElementById('frs-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("frs-title").innerHTML = "Pink Camo";
    document.getElementById('frs').style.fill = 'url("#defapCamo")'
    document.getElementById('color-picker-dropdown-frs').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frs-frsbCamo'){
    document.getElementById('frs-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("frs-title").innerHTML = "Blue Camo";
    document.getElementById('frs').style.fill = 'url("#defabCamo")'
    document.getElementById('color-picker-dropdown-frs').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frs-frswCamo'){
    document.getElementById('frs-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("frs-title").innerHTML = "White Camo";
    document.getElementById('frs').style.fill = 'url("#defawCamo")'
    document.getElementById('color-picker-dropdown-frs').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'frside-red'){
    document.getElementById('frside-label').style.background = 'red'
    document.getElementById("frside-title").innerHTML = "Red";
    document.getElementById('frside').style.fill = 'red'
    document.getElementById('color-picker-dropdown-frside').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'frs-red'){
    document.getElementById('frs-label').style.background = 'red'
    document.getElementById("frs-title").innerHTML = "Red";
    document.getElementById('frs').style.fill = 'red'
    document.getElementById('color-picker-dropdown-frs').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frs-grey'){
  ...
  if(color === 'frla-red'){
    document.getElementById('frla-label').style.background = 'red'
    document.getElementById("frla-title").innerHTML = "Red";
    document.getElementById('frla').style.fill = 'red'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frla').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'frla-frlagCamo'){
    document.getElementById('frla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png")'
    document.getElementById("frla-title").innerHTML = "Green Camo";
    document.getElementById('frla').style.fill = 'url("#defagCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frla-frlapCamo'){
    document.getElementById('frla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("frla-title").innerHTML = "Pink Camo";
    document.getElementById('frla').style.fill = 'url("#defapCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frla-frlabCamo'){
    document.getElementById('frla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("frla-title").innerHTML = "Blue Camo";
    document.getElementById('frla').style.fill = 'url("#defabCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frla').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'frla-frlawCamo'){
    document.getElementById('frla-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("frla-title").innerHTML = "White Camo";
    document.getElementById('frla').style.fill = 'url("#defawCamo1")'
    document.getElementById('caos-arm-logo').style.color = 'white'
    document.getElementById('color-picker-dropdown-frla').style.display = 'none'
    dropdownCtrl = true
  }
  ...
  if(color === 'fc-red'){
    document.getElementById('fc-label').style.background = 'red'
    document.getElementById("fc-title").innerHTML = "Red";
    document.getElementById('fc').style.fill = 'red'
    document.getElementById('bcol').style.fill = 'red'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fc-grey'){
  ...
  if(color === 'fc-fcgCamo'){
    ...
    document.getElementById('fc').style.fill = 'url("#fcgCamo")'
    document.getElementById('bcol').style.fill = 'url("#fcgCamo1")'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fc-fcpCamo'){
    document.getElementById('fc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975740/PinkCamo_1060x3582-1024x346_chsrqs.jpg")'
    document.getElementById("fc-title").innerHTML = "Pink Camo";
    document.getElementById('fc').style.fill = 'url("#fcpCamo")'
    document.getElementById('bcol').style.fill = 'url("#fcpCamo1")'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fc-fcbCamo'){
    document.getElementById('fc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975751/bluedigicamuntitled_bucyob.png")'
    document.getElementById("fc-title").innerHTML = "Blue Camo";
    document.getElementById('fc').style.fill = 'url("#fcbCamo")'
    document.getElementById('bcol').style.fill = 'url("#fcbCamo1")'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'fc-fcwCamo'){
    document.getElementById('fc-label').style.background = 'url("http://res.cloudinary.com/devmountain-discover/image/upload/v1496975761/whitecamourbancamodigital_rq1ybm.jpg")'
    document.getElementById("fc-title").innerHTML = "White Camo";
    document.getElementById('fc').style.fill = 'url("#fcwCamo")'
    document.getElementById('bcol').style.fill = 'url("#fcwCamo1")'
    document.getElementById('color-picker-dropdown-fc').style.display = 'none'
    dropdownCtrl = true
  }
  //pipeing
  ...
  if(color === 'pipe-red'){
    document.getElementById('pipe-label').style.background = 'red'
    document.getElementById("pipe-title").innerHTML = "Red";
    document.getElementById('front-pipeing').style.fill = 'red'
    document.getElementById('color-picker-dropdown-pipe').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'pipe-grey'){
  ...
  if(color === 'line-red'){
    document.getElementById('line-label').style.background = 'red'
    document.getElementById("line-title").innerHTML = "Red";
  ...
  if(color === 'line-flinegCamo'){
    document.getElementById('line-label').style.background = "url('http://res.cloudinary.com/devmountain-discover/image/upload/v1496952219/green-camo1_auzzel.png')"
    document.getElementById("line-title").innerHTML = "Green Camo";
    document.getElementById('front-lineing').style.fill = 'url("#flinegCamo")'
    document.getElementById('back-lineing').style.fill = 'url("#flinegCamo")'
    document.getElementById('color-picker-dropdown-line').style.display = 'none'
    dropdownCtrl = true
  }
...
function colorPickerSelectBack(color){
  ...
  if(color === 'back-red'){
    document.getElementById('back-label').style.background = 'red'
    document.getElementById("back-title").innerHTML = "Red";
    document.getElementById('back').style.fill = 'red'
    document.getElementById('color-picker-dropdown-back').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'back-grey'){
  ...
  if(color === 'blly-yellow'){
    ...
    document.getElementById("blly-title").innerHTMLx = "Yellow";
