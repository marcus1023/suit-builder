...
// Front
  ...
  let frcl = " Front Right Crotch: " + document.getElementById("frcl-title").innerHTML + " / "
  let flcl = " Front Left Crotch: " + document.getElementById("flcl-title").innerHTML + " / "
  ...
  let frly = " Front Right Bottom Leg: " + document.getElementById("frly-title").innerHTML + " / "
  let flly = " Front Left Bottom Leg: " + document.getElementById("flly-title").innerHTML + " / "
