...
// Front
  ...
  let allFrontValues = frla+frs+frside+frc+flc+flside+fls+flla+frly+flly+frul+flul+frll+flll+line+pipe
// Back
  ...
  let blly = " Back Left Leg: " + document.getElementById("blly-title").innerHTML + " / "
  let brly = " Back Right Leg: " + document.getElementById("brly-title").innerHTML + " / "
  ...
  let allBackValues = bback+blla+brla+blua+brua+brsh+blsh+blly+brly
//Measurements
...
function colorPickerSelectBack(color){
  ...
  if(color === 'blua-red'){
    ...
    document.getElementById('frbprev').style.fill = 'red'
    document.getElementById('color-picker-dropdown-blua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'blua-grey'){
  ...
  if(color === 'brua-aqua'){
    ...
    document.getElementById('flbprev').style.fill = '#129793'
  ...
  if(color === 'brua-neon-green'){
    ...
    document.getElementById('flbprev').style.fill = '#29f04f'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-hot-pink'){
    ...
    document.getElementById('flbprev').style.fill = '#e929f0'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-yellow'){
    ...
    document.getElementById('flbprev').style.fill = 'yellow'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-maroon'){
    ...
    document.getElementById('flbprev').style.fill = '#cb0039'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-red'){
    ...
    document.getElementById('flbprev').style.fill = 'red'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-grey'){
    ...
    document.getElementById('flbprev').style.fill = '#969696'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-navy'){
    ...
    document.getElementById('flbprev').style.fill = '#152c91'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-purple'){
    ...
    document.getElementById('flbprev').style.fill = 'purple'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-darkGreen'){
    ...
    document.getElementById('flbprev').style.fill = 'Green'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-darkGrey'){
    ...
    document.getElementById('flbprev').style.fill = '#494949'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-blue'){
    ...
    document.getElementById('flbprev').style.fill = 'blue'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-lime'){
    ...
    document.getElementById('flbprev').style.fill = '#09b600'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-white'){
    ...
    document.getElementById('flbprev').style.fill = 'White'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-black'){
    ...
    document.getElementById('flbprev').style.fill = 'Black'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'brua-teal'){
    ...
    document.getElementById('flbprev').style.fill = '#00b692'
    document.getElementById('color-picker-dropdown-brua').style.display = 'none'
    dropdownCtrl = true
  }
  if(color === 'blsh-aqua'){
