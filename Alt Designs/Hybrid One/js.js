...
// Front
  ...
  let allFrontValues = frla+flla+fre+fle+frua+flua+faly+frs+fls+frc+flc+fc+frcrotch+flcrotch+frul+flul+frly+flly+frll+flll
// Back
  ...
  let blul = " Back Left Upper Leg: " + document.getElementById("blul-title").innerHTML + " / "
  let brul = " Back Right Upper Leg: " + document.getElementById("brul-title").innerHTML + " / "
  ...
  let allBackValues = blla+brla+bleb+breb+blua+brua+blsh+brsh+back+blcr+brcr+blul+brul+blml+brml+blll+brll
  //measurements
  ...
  let allMeasurements = NECK_CIRCUMFERENCE+SHOULDER_TO_SHOULDER+SHOULDER_TO_ELBOW_LENGTH+CHEST_CIRCUMFERENCE+TORSO_LENGTH+BICEP_CIRCUMFERENCE+WAIST_CIRCUMFERENCE+HIPS_CIRCUMFERENCE+THIGH_CIRCUMFERENCE+CROTCH_TO_KNEE_LENGTH+ELBOW_TO_WRIST_LENGTH+FULL_ARM_BENT_LENGTH+IN_SEAM_LENGTH+CALF_CIRCUMFERENCE+LOWER_LEG_LENGTH+ANKLE_CIRCUMFERENCE+FOOT_LENGTH_SIZE
...
adminColorControl()
// colorPickerDropdownBack tester
